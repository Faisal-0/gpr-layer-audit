...
def run(case, output):
    ...
    contract = {
        ...
        "fixed": "Same dense states, native seeds, seed unary, tensor, slope bounds and margin gate",
        "missing": "Unsupported pairs cost 0.65/m and provide no correspondence evidence",
        "selection": "Two arms only, no learned model or threshold changes; reject added wrong length",
    }
